...
excerpt:   "Stackdriver Third-party Appication Monitoring (2.Cassandra)"
toc: true
toc_sticky: true
header:
...
![2016-09-12-csp-gcp-stackdriver-2-1.jpg](/images/csp/gcp/2016-09-12-csp-gcp-stackdriver-2-1.jpg)
...
```
![2016-09-12-csp-gcp-stackdriver-2-2.jpg](/images/csp/gcp/2016-09-12-csp-gcp-stackdriver-2-2.jpg)

## Plugin 설치

```bash
cd /opt/stackdriver/collectd/etc/collectd.d/ && sudo curl -O https://raw.githubusercontent.com/Stackdriver/stackdriver-agent-service-configs/master/etc/collectd.d/2-22.conf
...
![2016-09-12-csp-gcp-stackdriver-2-3.jpg](/images/csp/gcp/2016-09-12-csp-gcp-stackdriver-2-3.jpg)

Cassandra는 JVM 기반으로 동작하기에 친절한 Stackdriver는 JVM 모니터링까지 함께 할 수 있게 자료를 수집해서 보여준다.

![2016-09-12-csp-gcp-stackdriver-2-4.jpg](/images/csp/gcp/2016-09-12-csp-gcp-stackdriver-2-4.jpg)
