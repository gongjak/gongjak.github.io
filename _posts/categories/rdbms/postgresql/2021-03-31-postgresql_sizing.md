...
---
# 개요
DB 서버를 구성함에 가장 중요한 것이 용량 산정이다. 이를 기준으로 초기 디스크를 구성하고 용량을 정하기 때문이다. 모든 시스템 구성이 그러하듯 초기 구성 담당자가 하고 싶은 대로 하면 되는데, 여기에 개인적인 운영 경험을 조금 더해서 정리해보았다.
...
| 마운트 파티션 | 설치 위치 | 권장 용량 | 설명 |
|-|-|-|-|
| /engn001 | /engn001/postgresql | 50 GB | PostgreSQL DBMS Engine |
| /logs001 | /logs001/postgresql | 50 GB | pg_xlog
